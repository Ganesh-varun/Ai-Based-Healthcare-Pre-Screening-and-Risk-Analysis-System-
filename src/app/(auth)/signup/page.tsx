        ...
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6">
            ...
            >
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-500 text-sm">Join the protective health network</p>
                </div>
                ...
                <form className="space-y-4">
                    ...
                    <button className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/20 mt-4">
